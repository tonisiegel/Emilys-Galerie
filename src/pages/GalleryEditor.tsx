...
function SortablePhoto({
  ...
  return (
    ...
    >
      ...
      {/* Cover Badge */}
      {isCover && (
        <div className="absolute top-8 right-1 bg-amber-400 text-amber-900 text-xs font-medium px-1.5 py-0.5 rounded">
          {coverIndex + 1}
        </div>
      )}
      ...
      <button
        ...
        className={`absolute top-8 right-1 w-6 h-6 rounded-full flex items-center justify-center
             transition-all ${
               isCover
          ...
          {photo.markers.slice(0, 3).map((marker, idx) => {
            ...
            return (
              <svg
                ...
                height="18"
                viewBox="0 0 14 18"
                className={`${colorClass} drop-shadow`}
              >
      ...
      {/* File info on hover */}
      <div
        className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-2 pt-6
...
export function GalleryEditor() {
  ...
  const [availableMarkers, setAvailableMarkers] = useState<MarkerColor[]>([
    "green",
    "yellow",
  ]);
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        const photosData = await fetchGalleryPhotos(gallery.id);
  ...
  // Auto-generate random slug on mount
  useEffect(() => {
    if (isNew && !slug) {
  ...
  const onDrop = useCallback(
        ...
        const interval = setInterval(() => {
          ...
          if (progress >= 100) {
            ...
            const newPhoto: Photo = {
              ...
              markers: [],
              uploadedAt: new Date(),
              order: photos.length + uploadingPhotos.indexOf(file),
            };
    ...
    [id, photos.length, uploadingPhotos],
  );
    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          ...
          {coverPhotos.length > 0 && (
            <section className="card p-6">
              ...
              <p className="text-sm text-sage-500 mt-3">
                {coverPhotos.length}/3 Bilder ausgewählt. Klicke auf ⭐ bei den
                Fotos unten um Cover-Bilder zu wählen.
              </p>
            </section>
          )}
          ...
          {/* Options */}
          <section className="card p-6">
            <h2 className="text-lg font-medium text-sage-800 mb-4">Optionen</h2>
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  ...
                  <p className="text-sm text-sage-500">
                    Besucher können Fotos herunterladen
                  </p>
                </div>
                <button
                  type="button"
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  ...
                  <p className="text-sm text-sage-500">
                    Besucher können Fotos markieren
                  </p>
                </div>
                <button
                  type="button"
              ...
              {allowMarking && (
                <div className="pt-2">
                  ...
                  <div className="flex gap-4">
                    {(["green", "yellow", "red", "blue"] as MarkerColor[]).map(
                      (color) => {
              ...
              {isDragActive ? (
                ...
                <>
                  <p className="text-sage-600 mb-1">
                    ...
                    <span className="text-sage-700 underline">auswählen</span>
                  </p>
                  <p className="text-sm text-sage-400">JPG, PNG oder WebP</p>
                </>
              )}
            </div>
            ...
            {photos.length > 0 && (
              <div className="mt-6">
                <p className="text-sm text-sage-500 mb-3">
                  Ziehe Fotos um die Reihenfolge zu ändern. Klicke ⭐ für
                  Cover-Bilder.
                </p>
                <DndContext
                  sensors={sensors}
